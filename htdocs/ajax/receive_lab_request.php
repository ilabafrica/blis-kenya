...
if ($patient!=null){
	$tests_requested = API::getExternalLabRequest($patient->surrogateId,$labNo);
} else 
	$tests_requested = API::getExternalLabRequest($pid,$labNo);
    ...
    ?>
     ...
     $.post(
			...
			function(result) 
			{
				...
				$('#actionA'+labNo).attr('id','actionA'+test_details[1]+'');
