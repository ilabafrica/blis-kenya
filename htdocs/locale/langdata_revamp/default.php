...
$LANG_ARRAY = array ( 
	...
	"catalog" => array ( 
		...
		"TIPS_DRUGSNOTFOUND" => "No Drugs found in Catalog", 
		...
		"EDIT_DRUG_TYPE" => "Edit Drug Type", 
		"NEW_LAB_SECTION" => "New Lab Section", 
		"NEW_DRUG_TYPE" => "New Drug", 
		...
		"TIPS_MISSING_DRUGNAME" => "Error: Drug Name missing", 
		...
		"DRUG_TYPE_UPDATED" => "Drug Updated", 
		...
		"TIPS_TC_DRUGTYPE_1" => "Gives a complete listing of the available drug types.",
		"TIPS_TC_DRUGTYPE_2" => "Use this page to edit existing drug types.",
		"TIPS_TC_DRUGTYPE_3" => "You can also add new drug types using the 'Add New' option located near the top of the Page."
	) , 
	"reports" => array ( 
		"TITLE" => "Reports", 
