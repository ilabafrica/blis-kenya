...
$LANG_ARRAY = array ( 
		...
		"QUALITY_CONTROL_CATEGORY" => "Quality Control Categories", 
		"QUALITY_CONTROL_CATEGORIES" => "Quality Control Categories",
		"QUALITY_CONTROL_FIELD_GROUP" => "Quality Control Field Groups", 
		"QUALITY_CONTROL_FIELD_GROUPS" => "Quality Control Field Groups"
	) , 
	"header" => array ( 
		"TITLE" => "", 
	...
	"find_patient" => array ( 
		...
		"MENU_SPECIMEN_REGISTRATION"=>"Specimen Collection"
	) , 
	"new_patient" => array ( 
		"TITLE" => "New Patient", 
	...
	"quality" => array ( 
		...
		"QUALITY_CONTROL_FIELD_GROUPS" => "Quality Control Field Groups", 
		"QUALITY_CONTROL_FIELD_GROUP" => "Quality Control Field Groups",
		"TIPS_QC_1" => "Gives a complete listing of the available Quality Controls.", 
		"TIPS_QC_2" => "We can use this page to edit existing present Quality Controls.", 
		"TIPS_QC_3" => "New Quality Controls can also be added using the 'Add New' option located near the top of the Page.",
		"TIPS_QCC_1" => "Gives a complete listing of the available Quality Control Categories.", 
		"TIPS_QCC_2" => "We can use this page to edit existing present Quality Control Categories.", 
		"TIPS_QCC_3" => "New Quality Control Categories can also be added using the 'Add New' option located near the top of the Page.",
		"TIPS_QCFG_1" => "Gives a complete listing of the available Quality Control Field Groups.", 
		"TIPS_QCFG_2" => "We can use this page to edit existing present Quality Control Field Groups.", 
		"TIPS_QCFG_3" => "New Quality Control Field Groups can also be added using the 'Add New' option located near the top of the Page."
